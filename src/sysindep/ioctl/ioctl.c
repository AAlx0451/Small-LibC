...
static inline __attribute__((always_inline)) int termio_baud_to_speed(unsigned short cflag) {
    ...
    switch (baud) {
        ...
        case 8: return B600;
        case 9: return B1200;
        case 10: return B1800;
        case 11: return B2400;
        case 12: return B4800;
        case 13: return B9600;
        case 14: return EXTA;
        case 15: return EXTB;
...
int ioctl(int fd, unsigned long request, ...) {
    ...
    switch (request) {
        ...
        case TCSETAF:
            ...
            if (request == TCSETAF) action = TCSAFLUSH;
            else if (request == TCSETAW) action = TCSADRAIN;
            else action = TCSANOW;
        ...
        case TCXONC:
            switch ((int)arg) {
                case 0: action = TCOOFF; break;
                case 1: action = TCOON;  break;
                case 2: action = TCIOFF; break;
                case 3: action = TCION;  break;
                default: return -1;
            }
        ...
        case TCFLSH:
            switch ((int)arg) {
                case 0: queue = TCIFLUSH;  break;
                case 1: queue = TCOFLUSH;  break;
                case 2: queue = TCIOFLUSH; break;
                default: return -1;
            }
