...
#if !defined(_ANSI) &&                                                                             \
    (defined(_DARWIN_C_SOURCE) || defined(_GNU_SOURCE) ||                                          \
     (defined(_POSIX_C_SOURCE) && _POSIX_C_SOURCE >= 1) || defined(_XOPEN_SOURCE))
# include <sys/types.h>
# define CLK_TCK 100
#endif /* !_ANSI && (_DARWIN_C_SOURCE || _GNU_SOURCE || (_POSIX_C_SOURCE && _POSIX_C_SOURCE >= 1)  \
          || _XOPEN_SOURCE) */
...
#endif /* !_ANSI && (_DARWIN_C_SOURCE || _GNU_SOURCE || (__STDC_VERSION__ && __STDC_VERSION__ >=   \
          201112L) || (_POSIX_C_SOURCE && _POSIX_C_SOURCE >= 200112L) || (_XOPEN_SOURCE &&         \
          _XOPEN_SOURCE >= 600)) */
