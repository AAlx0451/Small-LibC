...
#  define _MSYS_COUNT_ARGS_LESS_1(...)                                                             \
      _MSYS_GET_NTH_ARG(__VA_ARGS__, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 0)
...
#  define mach_syscall(...)                                                                        \
      _MSYS_CONCAT(_mach_syscall, _MSYS_COUNT_ARGS_LESS_1(__VA_ARGS__))(__VA_ARGS__)
