...
#endif /* !_ANSI && (__STDC_VERSION__ && __STDC_VERSION__ >= 199901L) */
...
# if (defined(_POSIX_C_SOURCE) && _POSIX_C_SOURCE >= 2L) || defined(_XOPEN_SOURCE) ||              \
     defined(_GNU_SOURCE) || defined(_DARWIN_C_SOURCE)
...
# endif /* (_POSIX_C_SOURCE >= 2L) || _XOPEN_SOURCE || _GNU_SOURCE || _DARWIN_C_SOURCE */
...
#if defined(_XOPEN_SOURCE) || defined(_GNU_SOURCE) || defined(_DARWIN_C_SOURCE)
...
#endif /* _XOPEN_SOURCE || _GNU_SOURCE || _DARWIN_C_SOURCE */
