...
# define SIGPROF   27
          ...
          (_POSIX_C_SOURCE && _POSIX_C_SOURCE >= 200112L)) */
...
# if defined(_DARWIN_C_SOURCE) || (defined(_XOPEN_SOURCE) && _XOPEN_SOURCE >= 500) ||              \
     (defined(_POSIX_C_SOURCE) && _POSIX_C_SOURCE >= 200112L)
...
# endif /* _DARWIN_C_SOURCE || (_XOPEN_SOURCE && _XOPEN_SOURCE >= 500) || (_POSIX_C_SOURCE &&      \
...
#endif /* !_ANSI && (_DARWIN_C_SOURCE || (_XOPEN_SOURCE && _XOPEN_SOURCE >= 500) ||                \
          (_POSIX_C_SOURCE && _POSIX_C_SOURCE >= 199309L)) */
