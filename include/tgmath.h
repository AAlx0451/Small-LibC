...
#define ilog(x)                 _Generic((x), \
    long double:                ilogl(x), \
    double:                     ilog(x), \
    float:                      ilogf(x), \
    default:                    ilog((double)x) \
)
...
#define remquo(x, y, z)         _Generic((x) * (y), \
