...
# else
    speed_t __p[2];
# endif /* (_POSIX_C_SOURCE && _POSIX_C_SOURCE >= 200112L) || (_XOPEN_SOURCE && _XOPEN_SOURCE >=   \
           500) || _GNU_SOURCE || _DARWIN_C_SOURCE */
};
...
# if (defined(_XOPEN_SOURCE) && _XOPEN_SOURCE >= 500) || defined(_GNU_SOURCE) ||                   \
     defined(_DARWIN_C_SOURCE)
